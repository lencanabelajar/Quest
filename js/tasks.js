...
function checkAnswer(userAnswer) {
    // Menentukan jawaban yang benar untuk setiap pertanyaan
...
document.getElementById('task-form-1').addEventListener('submit', function(e) {
    e.preventDefault();
    checkAnswer('task-form-1', 'answer1', 'task-feedback1', correctAnswers.question1);
});

document.getElementById('task-form-2').addEventListener('submit', function(e) {
    e.preventDefault();
    checkAnswer('task-form-2', 'answer2', 'task-feedback2', correctAnswers.question2);
});

document.getElementById('task-form-3').addEventListener('submit', function(e) {
    e.preventDefault();
    checkAnswer('task-form-3', 'answer3', 'task-feedback3', correctAnswers.question3);
});

document.getElementById('task-form-4').addEventListener('submit', function(e) {
    e.preventDefault();
    checkAnswer('task-form-4', 'answer4', 'task-feedback4', correctAnswers.question4);
});

document.getElementById('task-form-5').addEventListener('submit', function(e) {
    e.preventDefault();
    checkAnswer('task-form-5', 'answer5', 'task-feedback5', correctAnswers.question5);
});

document.getElementById('task-form-6').addEventListener('submit', function(e) {
    e.preventDefault();
    checkAnswer('task-form-6', 'answer6', 'task-feedback6', correctAnswers.question6);
});

// Fungsi untuk memeriksa jawaban
function checkAnswer(formId, inputId, feedbackId, correctAnswer) {
