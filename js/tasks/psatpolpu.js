document.addEventListener('DOMContentLoaded', function () {
    ...
    const tasksData = [
        ...
        { questionId: "answer10", correctAnswer: "Keputusan yang diambil oleh pemerintah untuk mengatur masyarakat", options: ["Keputusan yang diambil oleh pemerintah untuk mengatur masyarakat", "Penyusunan anggaran oleh pemerintah pusat", "Sistem politik yang digunakan oleh negara", "Kebijakan luar negeri yang diterapkan oleh pemerintah"], xp: 20 },
        { questionId: "answer11", correctAnswer: "Memecahkan masalah sosial yang terjadi di masyarakat", options: ["Memusatkan kekuasaan pada pemerintah pusat", "Memecahkan masalah sosial yang terjadi di masyarakat", "Meningkatkan pertumbuhan ekonomi negara lain", "Mengurangi peran pemerintah daerah"], xp: 20 },
        { questionId: "answer12", correctAnswer: "Identifikasi masalah", options: ["Identifikasi masalah", "Evaluasi kebijakan", "Pelaksanaan proyek", "Pengumpulan dana"], xp: 20 },
        { questionId: "answer13", correctAnswer: "Masyarakat", options: ["Pemerintah pusat", "Masyarakat", "Lembaga internasional", "Swasta"], xp: 20 },
        { questionId: "answer14", correctAnswer: "Program subsidi pendidikan dan kesehatan", options: ["Program subsidi pendidikan dan kesehatan", "Pembentukan koalisi politik", "Pemberian bantuan ke negara lain", "Pembangunan pangkalan militer"], xp: 20 },
        { questionId: "answer15", correctAnswer: "Untuk mengatasi masalah yang ada di masyarakat", options: ["Untuk meningkatkan dominasi pemerintah", "Untuk mengatasi masalah yang ada di masyarakat", "Untuk memperluas pengaruh internasional", "Untuk memusatkan semua urusan keuangan"], xp: 20 }
    ];
