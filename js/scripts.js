...
const taskData = [
    ...
    { judul: '🛠 Cooming Soon', link: '../html/tasks/coomingsoon.html', kategori: 'Offline', icon: 'ruby.png' },
    { judul: '🛠 Cooming Soon', link: '../html/tasks/coomingsoon.html', kategori: 'Offline', icon: 'ruby.png' },
    { judul: '🛠 Cooming Soon', link: '../html/tasks/coomingsoon.html', kategori: 'Offline', icon: 'ruby.png' },
];
...
function showPage(page) {
    ...
    taskList.innerHTML = ''; // Hapus konten sebelumnya

    // Menambahkan task sesuai dengan halaman
